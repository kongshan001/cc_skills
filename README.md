...
| [SKILLS_SURVEY_2026_03_WEEK67](./SKILLS_SURVEY_2026_03_WEEK67.md) | Claude Code Skills 调研报告（第六十七周），GitHub API 实时搜索热门 Skills，游戏客户端开发（Claude-Code-Game-Studios 30⭐/Unity-MCP 6580⭐/Godot-MCP 480⭐/Unity AI Workflow 2026 新增）/Python开发（claudex 224⭐/pydantic-ai-skills 140⭐/beagle 37⭐）/自动化测试（Playwright 1.86k⭐/agentic-qe 218⭐/QA WorkFlow 新增）/开发者工具（skillnote 5⭐/cli-godmode 新增）完整覆盖，skills.sh 官方 Top 10 排行榜分析 | 🆕 新增 |
| [SKILLS_SURVEY_2026_03_WEEK66](./SKILLS_SURVEY_2026_03_WEEK66.md) | Claude Code Skills 调研报告（第六十六周），GitHub API 实时搜索热门 Skills，游戏客户端开发（Claude-Code-Game-Studios 30⭐/Unity-MCP 6580⭐/Godot-MCP 480⭐）/Python开发（claudex 224⭐/beagle 37⭐/security-antipatterns-python 新增）/自动化测试（Playwright 1.86k⭐/agentic-qe 218⭐/eval-view 49⭐ 新增）/开发者工具（claude-codex-settings 448⭐/skillnote 5⭐ 新增）完整覆盖 | 🆕 新增 |
