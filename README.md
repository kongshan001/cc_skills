...
| [SKILLS_SURVEY_2026_03_WEEK59](./SKILLS_SURVEY_2026_03_WEEK59.md) | Claude Code Skills 调研报告（第五十九周），GitHub/ClawHub 实时搜索热门 Skills，游戏客户端开发（Claude-Code-Game-Studios 30⭐/orchestkit 101⭐/Unreal 27 skills）/Python开发（python-executor 3.484⭐/claudex 223⭐）/自动化测试（Playwright 1.86k⭐/dev-browser 3.76k⭐）/开发者工具（ai-guide 8.9k⭐）完整覆盖 | 🆕 新增 |
